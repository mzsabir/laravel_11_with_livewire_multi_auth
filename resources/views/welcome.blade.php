      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            ...
            <p class="mb-4">We have help thousands of people to get relief from national wide fights wrongfull denials. Now they trusted Best Lawyer attorneys</p>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
        	...
        	<div class="col-md-12 text-center mt-4">
        		<a href="#" class="btn btn-primary px-5">See All Successful Cases</a>
        	</div>
        </div>
    	</div>
    </section>
